...
::  Thanks to Supporter Nguyen Tien Loi
...
::  Thanks to Supporter Nguyen Tien Loi for the powershell method and solving special characters issue in file path name.
...
cls
title  Activate IDM To PITVN  ^(By Supporter Nguyen Tien Loi)
mode 65, 25
...
start https://www.youtube.com/channel/UCvosxYqxIiUfe4nq7sMjmkg
goto MainMenu
...
If not defined name set name=Supporter Nguyen Tien Loi
...
set "reg=HKCU\SOFTWARE\DownloadManager /v Email /t REG_SZ /d "lienhe@nguyentienloi.email"" & call :_rcont
set "reg=HKCU\SOFTWARE\DownloadManager /v Serial /t REG_SZ /d "PITVN-DMSTL-HI7FD-HG2U6"" & call :_rcont
...
::  Written by Supporter Nguyen Tien Loi
::  https://www.youtube.com/channel/UCvosxYqxIiUfe4nq7sMjmkg
...
_________________________________
   ...
   Activation IDM To PITVN
   
   Iboxs:    https://m.me/page.damaso.nguyentienloi
   Youtube:  https://www.youtube.com/channel/UCvosxYqxIiUfe4nq7sMjmkg
   Page:     https://www.facebook.com/page.damaso.nguyentienloi
   Email:    lienhe@nguyentienloi.email
